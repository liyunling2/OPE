...
## STEP BY STEP to run streamlit dashboard
1. create virtual environment
2. install requirements `pip install -r requirements.txt`
3. Run clustering notebook first because it relies on clustering results file generated by clustering notebook (or else clustering page will not have the updated data)
4. Create cohere API key if you want to generate strategy
5. Run the python streamlit dashboard `python3 -m streamlit run frontend_dashboard/app.py`
